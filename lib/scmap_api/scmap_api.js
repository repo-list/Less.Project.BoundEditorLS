 ...
 */
 ...
 /*
  * SCMapAPI의 로딩이 완료되었을 경우, document 객체에 JavaScript의 onscmapapiload 이벤트 및 jQuery의 scmapapiload 이벤트가 발생합니다.
  */
...
const SCMapAPI = {
    ...
    drawLocation : function(canvasContext, gridWidth, gridHeight, location, fillColorStr, alphaVal, borderWidth, borderColorStr, fontColorStr) {},
...
(function() {
    ...
    SCMapAPI.drawLocation = function(canvasContext, gridWidth, gridHeight, location, fillColorStr, alphaVal, borderWidth, borderColorStr, fontColorStr) {
        ...
        canvasContext.fillStyle = (fontColorStr === undefined) ? "#10fc18" : fontColorStr;
    ...
    SCLocation = function(label, posX, posY, lenX, lenY) {
        ...
        this.setPosition = function(newPosX, newPosY) { posX = newPosX; posY = newPosY; };
        this.selected = false;
        this.flags = {
            lowGround : true,
            medGround : true,
    ...
    function checkAndLoadTileset() {
        ...
        if (!Tileset.Badlands.complete ||
            ...
            $(document).trigger("scmapapiload"); // jQuery 문법 사용하는 유일한 부분
        }
    }
